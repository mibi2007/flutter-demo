...
class _$_SignUpFormState implements _SignUpFormState {
  const _$_SignUpFormState(
      ...
      this.registerFailureOrSuccessOption});
  ...
  @override
  String toString() {
    return 'SignUpFormState(emailAddress: $emailAddress, password: $password, isSubmitting: $isSubmitting, shouldshowErrorMessages: $shouldshowErrorMessages, registerFailureOrSuccessOption: $registerFailureOrSuccessOption)';
  }
